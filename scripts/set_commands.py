...
COMMANDS = [
    ...
    ("setup", "⚙️ Set saldo awal (sekali)"),
    ("lock", "🔒 Kunci periode (YYYY-MM)"),
    ("reverse", "↩️ Batalkan transaksi (DOC)"),
    ("reset", "🔄 Batalkan input berjalan"),
    ("undo", "↩️ Batalkan 1 transaksi terakhir"),
    ("budget", "💰 Atur budget kategori"),
    ("budgets", "💰 Lihat semua budget"),
    ("goal", "🎯 Tambah target tabungan"),
    ("goals", "🎯 Lihat progress goals"),
    ("recurring", "🔁 Transaksi berulang"),
    ("bill", "🧾 Tambah tagihan"),
    ("bills", "🧾 Lihat semua tagihan"),
    ("tag", "🏷️ Tag transaksi"),
    ("tags", "🏷️ Lihat semua tag"),
    ("kategori", "📂 Tambah kategori custom"),
