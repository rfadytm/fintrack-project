...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-40 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 bg-navy/90 backdrop-blur-xl text-white px-4 sm:px-6 py-3 shadow-md">
      <NavLink
        to="/dashboard"
